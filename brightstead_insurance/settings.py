"""
Django settings for brightstead_insurance project.
...
SECRET_KEY = 'django-insecure-&$&#nt=yy*zvu@0e0!a*z7g0e+o)+ebnn2mz8)_peae4524v(8'
...
ROOT_URLCONF = 'brightstead_insurance.urls'
...
WSGI_APPLICATION = 'brightstead_insurance.wsgi.application'
